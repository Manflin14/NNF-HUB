          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'gkDiving', points: 10 }, { attr: 'gkReflexes', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'gkHandling', points: 12 }, { attr: 'gkPositioning', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'gkReflexes', points: 12 }, { attr: 'gkDiving', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'gkPositioning', points: 9 }, { attr: 'jumping', points: 7 }, { attr: 'strength', points: 7 }],
            },
            {
              ...
              priorities: [{ attr: 'gkHandling', points: 12 }, { attr: 'stamina', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'acceleration', points: 10 }, { attr: 'sprintSpeed', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'gkKicking', points: 12 }, { attr: 'gkPositioning', points: 10 }],
            },
            {
            ...
            },
            {
              ...
              priorities: [{ attr: 'acceleration', points: 12 }, { attr: 'strength', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'defAwareness', points: 10 }, { attr: 'standTackle', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'acceleration', points: 12 }, { attr: 'sprintSpeed', points: 10 }],
            },
            {
              fromLevel: 11, toLevel: 15, label: 'Consolidação', pointsGained: 22,
              focus: 'Equilibre Interceptações e Cabecear para fechar os dois tipos de ameaça.',
              priorities: [{ attr: 'interceptions', points: 12 }, { attr: 'headingAccuracy', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'longPass', points: 12 }, { attr: 'stamina', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Força e Carrinho no Chão para fechar todas as situações defensivas.',
              priorities: [{ attr: 'strength', points: 12 }, { attr: 'slideTackle', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'strength', points: 10 }, { attr: 'headingAccuracy', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'defAwareness', points: 12 }, { attr: 'interceptions', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'jumping', points: 12 }, { attr: 'aggression', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'standTackle', points: 12 }, { attr: 'slideTackle', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Distribua entre Reações e Resistência para manter alto nível no segundo tempo.',
              priorities: [{ attr: 'reactions', points: 12 }, { attr: 'stamina', points: 11 }],
            },
          ],
        },
      },
        ...
        progression: {
          ...
          tiers: [
            ...
            },
            {
              ...
              focus: 'Evolua Cruzamento e Curva para gerar chances reais de gol a partir dos flancos.',
              priorities: [{ attr: 'crossing', points: 12 }, { attr: 'curve', points: 10 }],
            },
            {
              fromLevel: 11, toLevel: 15, label: 'Habilidade', pointsGained: 22,
              focus: 'Suba Dribles e Agilidade para ter mais opções ao entrar na área ou pressionar pela lateral.',
              priorities: [{ attr: 'dribbling', points: 12 }, { attr: 'agility', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'defAwareness', points: 12 }, { attr: 'slideTackle', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Resistência e Passe Curto para ter volume de jogo do início ao fim.',
              priorities: [{ attr: 'stamina', points: 12 }, { attr: 'shortPass', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'stamina', points: 20 }],
            },
            {
              fromLevel: 6, toLevel: 10, label: 'Ritmo', pointsGained: 22,
            ...
            },
            {
              ...
              priorities: [{ attr: 'defAwareness', points: 12 }, { attr: 'standTackle', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'shortPass', points: 12 }, { attr: 'longPass', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Interceptações e Reações para fechar o perfil completo do lateral equilibrado.',
              priorities: [{ attr: 'interceptions', points: 12 }, { attr: 'reactions', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'defAwareness', points: 10 }, { attr: 'interceptions', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'shortPass', points: 12 }, { attr: 'reactions', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'stamina', points: 12 }, { attr: 'aggression', points: 10 }],
            },
            {
            ...
            },
            {
              ...
              priorities: [{ attr: 'longPass', points: 12 }, { attr: 'vision', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'shortPass', points: 10 }, { attr: 'ballControl', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'vision', points: 12 }, { attr: 'longPass', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'reactions', points: 12 }, { attr: 'composure', points: 10 }],
            },
            {
              fromLevel: 16, toLevel: 20, label: 'Defensivo', pointsGained: 23,
              focus: 'Invista em Def. Awareness e Interceptações para equilibrar o perfil.',
              priorities: [{ attr: 'defAwareness', points: 12 }, { attr: 'interceptions', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Dribles e Agilidade para ter opções ao sair de pressão em espaços reduzidos.',
              priorities: [{ attr: 'dribbling', points: 12 }, { attr: 'agility', points: 11 }],
            },
          ],
        },
      },
        ...
        progression: {
          ...
          tiers: [
            ...
            },
            {
              ...
              priorities: [{ attr: 'vision', points: 12 }, { attr: 'reactions', points: 10 }],
            },
            {
            ...
            },
            {
              ...
              priorities: [{ attr: 'attPosition', points: 12 }, { attr: 'longShots', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Compostura e Resistência para manter alto nível nos momentos decisivos.',
              priorities: [{ attr: 'composure', points: 12 }, { attr: 'stamina', points: 11 }],
            },
          ],
        },
      },
        ...
        progression: {
          ...
          tiers: [
            ...
            },
            {
              ...
              priorities: [{ attr: 'strength', points: 12 }, { attr: 'aggression', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Carrinho em Pé e Visão para fechar o perfil do meia completo.',
              priorities: [{ attr: 'standTackle', points: 12 }, { attr: 'vision', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'vision', points: 10 }, { attr: 'shortPass', points: 10 }],
            },
            {
              fromLevel: 6, toLevel: 10, label: 'Criação', pointsGained: 22,
              focus: 'Suba Controle de Bola e Curva para criar mais opções de último passe e bola parada.',
              priorities: [{ attr: 'ballControl', points: 12 }, { attr: 'curve', points: 10 }],
            },
            {
              fromLevel: 11, toLevel: 15, label: 'Drible', pointsGained: 22,
            ...
            },
            {
              ...
              priorities: [{ attr: 'longShots', points: 12 }, { attr: 'attPosition', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Passe Longo e Cruzamento para maximizar a variedade do jogo criativo.',
              priorities: [{ attr: 'longPass', points: 12 }, { attr: 'crossing', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'dribbling', points: 10 }, { attr: 'agility', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'ballControl', points: 12 }, { attr: 'balance', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'finishing', points: 12 }, { attr: 'attPosition', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'acceleration', points: 12 }, { attr: 'reactions', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Compostura e Chute Longo para ser ameaça em todas as situações ofensivas.',
              priorities: [{ attr: 'composure', points: 12 }, { attr: 'longShots', points: 11 }],
            },
          ],
        },
      },
        ...
        progression: {
          ...
          tiers: [
            ...
            },
            {
              ...
              priorities: [{ attr: 'finishing', points: 12 }, { attr: 'attPosition', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Compostura e Cruzamento para ter mais opções quando entrar na área.',
              priorities: [{ attr: 'composure', points: 12 }, { attr: 'crossing', points: 11 }],
            },
          ],
        },
      },
        ...
        progression: {
          ...
          tiers: [
            ...
            },
            {
              ...
              priorities: [{ attr: 'reactions', points: 12 }, { attr: 'shotPower', points: 10 }],
            },
            {
              ...
              priorities: [{ attr: 'dribbling', points: 12 }, { attr: 'ballControl', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Resistência e Compostura para manter a performance nos momentos decisivos.',
              priorities: [{ attr: 'stamina', points: 12 }, { attr: 'composure', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'attPosition', points: 10 }, { attr: 'finishing', points: 10 }],
            },
            {
            ...
            },
            {
              ...
              priorities: [{ attr: 'shotPower', points: 12 }, { attr: 'volleys', points: 10 }],
            },
            {
              fromLevel: 16, toLevel: 20, label: 'Físico', pointsGained: 23,
              focus: 'Invista em Força e Cabeceio para disputar bem a bola na área em cobranças de bola parada.',
              priorities: [{ attr: 'strength', points: 12 }, { attr: 'headingAccuracy', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
              focus: 'Complete Chute Longo e Pênaltis para fechar todas as situações de finalização.',
              priorities: [{ attr: 'longShots', points: 12 }, { attr: 'penalties', points: 11 }],
            },
          ],
        },
      },
          ...
          tiers: [
            {
              ...
              priorities: [{ attr: 'dribbling', points: 10 }, { attr: 'attPosition', points: 10 }],
            },
            {
              fromLevel: 6, toLevel: 10, label: 'Finalização', pointsGained: 22,
              focus: 'Evolua Finalização e Agilidade para converter os dribles em gols reais.',
              priorities: [{ attr: 'finishing', points: 12 }, { attr: 'agility', points: 10 }],
            },
            {
              fromLevel: 11, toLevel: 15, label: 'Controle', pointsGained: 22,
            ...
            },
            {
              ...
              focus: 'Suba Aceleração e Reações para ter explosão nos primeiros metros e converter rebotes.',
              priorities: [{ attr: 'acceleration', points: 12 }, { attr: 'reactions', points: 11 }],
            },
            {
              fromLevel: 21, toLevel: 25, label: 'Maestria', pointsGained: 23,
